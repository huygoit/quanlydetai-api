...
const TO_ADD: Array<{ code: string; name: string; module: string; action: string }> = [
  ...
  { code: 'staff_position.view', name: 'Xem danh mục chức vụ', module: 'staff_position', action: 'view' },
  { code: 'staff_position.create', name: 'Tạo chức vụ', module: 'staff_position', action: 'create' },
  { code: 'staff_position.update', name: 'Cập nhật chức vụ', module: 'staff_position', action: 'update' },
  { code: 'staff_position.delete', name: 'Xóa chức vụ', module: 'staff_position', action: 'delete' },
  {
    code: 'project_process_type.view',
    name: 'Xem danh mục cấp ý tưởng/đề tài',
    module: 'project_process_type',
    action: 'view',
  },
  {
    code: 'project_process_type.create',
    name: 'Tạo cấp ý tưởng/đề tài',
    module: 'project_process_type',
    action: 'create',
  },
  {
    code: 'project_process_type.update',
    name: 'Cập nhật cấp ý tưởng/đề tài',
    module: 'project_process_type',
    action: 'update',
  },
  {
    code: 'project_process_type.delete',
    name: 'Xóa cấp ý tưởng/đề tài',
    module: 'project_process_type',
    action: 'delete',
  },
]
